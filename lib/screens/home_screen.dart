...
class _WeatherAppHomeScreenState extends ConsumerState<WeatherAppHomeScreen> {
  ...
  Future<void> _fetchWeather() async {
    ...
    try {
      ...
      final past = await _weatherService.getpastSevenDaysWerther(city);
      setState(() {
        currentValue = forecast['current'] ?? {};
        hourly = forecast['forecast']?['forecastday']?[0]?['hour'] ?? [];

        // fore next 7 day forecast
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          SizedBox(height: 20),
          // You can add more widgets here to display weather data
          if (isloading) ////////if
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Image.network(
                                "https://cdn-icons-png.flaticon.com/512/2529/2529971.png",
                                width: 30,
                                height: 30,
                              ),
                              Text(
